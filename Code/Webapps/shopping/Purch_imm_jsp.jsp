...
%>
 ...
 <%
	...
	st=con.createStatement();
        rs=st.executeQuery("select * from prod_det where present_stock<min_stock");
 %> 
 <html>
 <body >    
 <head><FONT  face="comic sans ms" size=3 COLOR=#006600><center><hr color=#99CC00>Items To Be Purchased Immediately<hr color=#99CC00></center></font></head> 
